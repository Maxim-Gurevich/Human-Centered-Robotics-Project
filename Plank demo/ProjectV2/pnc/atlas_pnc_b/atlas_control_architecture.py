...
from pnc.atlas_pnc_b.atlas_task_force_container import AtlasTaskForceContainer
from pnc.atlas_pnc_b.atlas_controller import AtlasController
from pnc.atlas_pnc_b.atlas_state_machine.double_support_stand import DoubleSupportStand
from pnc.atlas_pnc_b.atlas_state_machine.double_support_balance import DoubleSupportBalance
from pnc.atlas_pnc_b.atlas_state_machine.contact_transition_start import ContactTransitionStart
from pnc.atlas_pnc_b.atlas_state_machine.contact_transition_end import ContactTransitionEnd
from pnc.atlas_pnc_b.atlas_state_machine.single_support_swing import SingleSupportSwing
from pnc.atlas_pnc_b.atlas_state_provider import AtlasStateProvider
##########################################################
#
from pnc.wbc.manager.hand_trajectory_manager import HandTrajectoryManager
from pnc.atlas_pnc_b.atlas_state_machine.double_support_hand_reaching import DoubleSupportHandReach
#
##########################################################
class AtlasControlArchitecture(ControlArchitecture):
    def __init__(self, robot):
        ...
        ###
        self._lh_target_pos = WalkingConfig.LH_TARGET_POSB
        self._rh_target_pos = WalkingConfig.RH_TARGET_POSB
        self._trans_duration = WalkingConfig.T_TRANS_DURATION
        self._moving_duration = WalkingConfig.T_REACHING_DURATION
        self._start_time = 0.
        ###
            ###########################################################
            #
        self._lhand_tm = HandTrajectoryManager(
            self._taf_container.lhand_pos_task, None, self._robot)
        self._rhand_tm = HandTrajectoryManager(
            self._taf_container.rhand_pos_task, None, self._robot)
            #
            ###########################################################
        ...
        self._state_machine[
            WalkingState.
            BALANCE].moving_duration = WalkingConfig.T_REACHING_DURATION
            #RH_HANDREACH].moving_duration = WalkingConfig.T_REACHING_DURATION
        self._state_machine[
            WalkingState.
            BALANCE].rh_target_pos = WalkingConfig.RH_TARGET_POSB
            #RH_HANDREACH].rh_target_pos = WalkingConfig.RH_TARGET_POS
        self._state_machine[
            WalkingState.
            BALANCE].trans_duration = WalkingConfig.T_TRANS_DURATION
        ...
        self._state_machine[
            WalkingState.
            BALANCE].lh_target_pos = WalkingConfig.LH_TARGET_POSB
