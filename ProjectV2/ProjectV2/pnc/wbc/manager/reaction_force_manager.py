...
class ReactionForceManager(object):
    ...
    def update_ramp_to_min(self, current_time):
        ...
        self.self._minimum_rf_z_max : Final time upper bound at self._start_time
                                      + self._duration
        """
        self._contact.rf_z_max = self._starting_rf_z_max+(self._minimum_rf_z_max-self._starting_rf_z_max)*\
        (t-self._start_time)/self._duration
    ...
    def update_ramp_to_max(self, current_time):
        ...
        """
        self._contact.rf_z_max = self._starting_rf_z_max+(self._maximum_rf_z_max-self._starting_rf_z_max)*\
        (t-self._start_time)/self._duration
