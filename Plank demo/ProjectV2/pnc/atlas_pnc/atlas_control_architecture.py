...
class AtlasControlArchitecture(ControlArchitecture):
    def __init__(self, robot):
        ...
        ###
        self._lh_target_pos = WalkingConfig.LH_TARGET_POS
        self._rh_target_pos = WalkingConfig.RH_TARGET_POS
        ...
        self._state_machine[
            WalkingState.
            BALANCE].rh_target_pos = WalkingConfig.RH_TARGET_POS
        ...
        self._state_machine[
            WalkingState.
            BALANCE].lh_target_pos = WalkingConfig.LH_TARGET_POS
